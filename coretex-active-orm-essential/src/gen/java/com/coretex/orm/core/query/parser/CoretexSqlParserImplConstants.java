/* Generated By:JavaCC: Do not edit this line. CoretexSqlParserImplConstants.java */
package com.coretex.orm.core.query.parser;

public interface CoretexSqlParserImplConstants {
  ...
  int BIG_QUERY_BACK_QUOTED_IDENTIFIER = 750;
  int HYPHENATED_IDENTIFIER = 751;
  int IDENTIFIER = 752;
  int COLLATION_ID = 753;
  int UNICODE_QUOTED_IDENTIFIER = 754;
  int LETTER = 755;
  int DIGIT = 756;
  int BEL = 757;
