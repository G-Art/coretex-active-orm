 ...
 ***********************************************************************
 */
@EssentialDataItemColumn(itemCode = META_ENUM_TYPE, columnName = 'enumCode')
class MetaEnumEnumCodeColumn extends Column<EnumItemDiffDataHolder, MetaEnumTypeUpdate> {
