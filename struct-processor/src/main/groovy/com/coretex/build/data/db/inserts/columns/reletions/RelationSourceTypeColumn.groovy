 ...
 ***********************************************************************
 */
@EssentialDataItemColumn(itemCode = META_RELATION_TYPE, columnName = 'sourceType')
class RelationSourceTypeColumn extends Column<RelationInsert.RelationData> {

    @Override
    Object getRawValue() {
        return data.sourceType.uuid
    }
