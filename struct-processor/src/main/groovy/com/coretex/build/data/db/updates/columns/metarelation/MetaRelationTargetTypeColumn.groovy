 ...
 ***********************************************************************
 */
@EssentialDataItemColumn(itemCode = META_TYPE, supportedItem = RelationItem, columnName = 'targetType')
class MetaRelationTargetTypeColumn extends Column<RelationItemDiffDataHolder, Update> {

    @Override
    Object getValue() {
        return "'${data.item.targetAttribute.type.uuid}'"
    }
}
