...
class MetaAttributeTypeAttributeTypeCodeColumn extends Column<AttributeItemDiffDataHolder, MetaAttributeTypeUpdate> {

    @Override
    Object getValue() {
        return "'${update.essentialValueType.code}'"
    }
}
