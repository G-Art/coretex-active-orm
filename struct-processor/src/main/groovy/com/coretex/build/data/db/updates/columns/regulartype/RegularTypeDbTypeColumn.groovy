 ...
 ***********************************************************************
 */
@EssentialDataItemColumn(itemCode = REGULAR_TYPE, columnName = 'dbType')
class RegularTypeDbTypeColumn extends Column<RegularClassItemDiffDataHolder, RegularClassTypeUpdate> {
    ...
    private String retrieveDbType() {
        return buildContext.dbDialect.typeAppropriateService.getBasicDataType(data.item)
    }
}
