 ...
 ***********************************************************************
 */
@EssentialDataItemColumn(itemCode = META_RELATION_TYPE, columnName = 'targetType')
class RelationTargetTypeColumn extends Column<RelationInsert.RelationData> {

    @Override
    Object getRawValue() {
        return data.targetType.uuid
    }
