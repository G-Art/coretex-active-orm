 ...
 ***********************************************************************
 */
@EssentialDataItemColumn(itemCode = META_RELATION_TYPE, columnName = 'source')
class RelationSourceColumn extends Column<RelationInsert.RelationData> {

    @Override
    Object getRawValue() {
        return data.source.uuid
    }
