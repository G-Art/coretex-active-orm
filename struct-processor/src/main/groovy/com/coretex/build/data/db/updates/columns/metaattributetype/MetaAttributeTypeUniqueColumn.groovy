 ...
 ***********************************************************************
 */
@EssentialDataItemColumn(itemCode = META_ATTRIBUTE_TYPE, columnName = 'unique')
class MetaAttributeTypeUniqueColumn extends Column<AttributeItemDiffDataHolder, MetaAttributeTypeUpdate> {
