 ...
 ***********************************************************************
 */
abstract class Insert<T extends RowItem> implements DbCommands {

    private static final String ACTIONS_PATH = 'com.coretex.build.data.db.inserts'
    ...
    String getTableName() {
        return essentialItem.tableName
    }
