 ...
 ***********************************************************************
 */
@EssentialDataItemColumn(itemCode = META_TYPE, supportedItem = RelationItem, columnName = 'targetAttribute')
class MetaRelationSourceTargetColumn extends Column<RelationItemDiffDataHolder, Update> {

    @Override
    Object getValue() {
        return "'${data.item.targetAttribute.uuid}'"
    }
}
