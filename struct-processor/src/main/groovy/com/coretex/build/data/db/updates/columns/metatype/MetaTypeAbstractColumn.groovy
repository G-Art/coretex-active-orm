 ...
 ***********************************************************************
 */
@EssentialDataItemColumn(itemCode = META_TYPE, columnName = 'abstract')
class MetaTypeAbstractColumn extends Column<AbstractClassItemDiffDataHolder, Update> {

    @Override
    Object getValue() {
        return "${data.item.getAbstract()}"
    }
}
