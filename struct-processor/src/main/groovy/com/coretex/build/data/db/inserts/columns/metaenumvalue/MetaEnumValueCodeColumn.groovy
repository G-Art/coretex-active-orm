 ...
 ***********************************************************************
 */
@EssentialDataItemColumn(itemCode = META_ENUM_VALUE_TYPE, columnName = 'code')
class MetaEnumValueCodeColumn extends Column<MetaEnumValueTypeInsert.ValueForEnumItem> {
