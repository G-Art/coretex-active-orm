 ...
 ***********************************************************************
 */
@EssentialDataItemColumn(itemCode = META_ATTRIBUTE_TYPE, columnName = 'optional')
class MetaAttributeTypeOptionalColumn extends Column<AttributeItemDiffDataHolder, MetaAttributeTypeUpdate> {
