...
public class MetaTypeInheritanceRelation extends GenericItem {

    public static final String ITEM_TYPE = "MetaTypeInheritanceRelation";
    ...
    *                        @localized     : false
    *                        @associated    : false
    *                        @owner         : MetaTypeInheritanceRelation
    *                        @type          : LocalDateTime
    *
    * ------------------------------------------------------------------------------------------------------------------
    */
    ...
    */
    ...
    public MetaTypeInheritanceRelation() {
        super();
    }

    public MetaTypeInheritanceRelation(ItemContext ctx) {
        super(ctx);
    }
...
* Specify source insistence
*/
public void setSource(MetaTypeItem source){
